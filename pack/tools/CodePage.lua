...
local function UpdateStatusCodePage(mode)
	...
	if mode == nil or mode == IDM_ENCODING_DEFAULT then
		if props["character.set"]=='255' then
			props["chars.accented"]='Ђ ЃЎ‚ўѓЈ„¤…Ґрс†¦‡§€Ё‰©ЉЄ‹«Њ¬Ќ­Ћ®ЏЇђа‘б’в“г”д•е–ж—зи™йљк›лњмќнћоџп'
		else
			props["chars.accented"]='АаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя'
		end
	else -- utf8
		props["chars.accented"]='РђР°Р‘Р±Р’РІР“РіР”РґР•РµРЃС‘Р–Р¶Р—Р·РРёР™Р№РљРєР›Р»РњРјРќРЅРћРѕРџРїР СЂРЎСЃРўС‚РЈСѓР¤С„РҐС…Р¦С†Р§С‡РЁС€Р©С‰РЄСЉР«С‹Р¬СЊР­СЌР®СЋРЇСЏ'
	end
