...
--[[--------------------------------------------------------------------------------------
Строка ниже - полная лажа :( Восстановление фолдинга НЕ РАБОТАЕТ.
На команду editor:ToggleFold(line_num) (или на scite.SendEditor(SCI_TOGGLEFOLD, line_num))
SciTE НИКАК не реагирует - имхо БАГ ядра программы.
...
Ну в общем проблем, возникающих при решении этой, на первый взгляд, тривиальной задачи, всплывает предостаточно...
--]]--------------------------------------------------------------------------------------
