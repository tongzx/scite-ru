...
------------------------------------------------------
Usage:
	local IsURI = dofile"recognizeurl.lua"
--]]--------------------------------------------------
...
..[[
	...
	gen_delims    <- [][:/?#@]	--":" / "/" / "?" / "#" / "[" / "]" / "@"
	--@ amended sub_delims: there's no good possibility to distinguish between ")" as part of URL,
	--- and ")" as close bracket AFTER the URL.
	--sub_delims    <- [!$&'()*+,;=]
	sub_delims    <- [$&'*+=]
]]
-- common defs
..'	ALPHA          <-  [\65-\90\97-\122]	'   --; A-Z / a-z
..'	BIT            <-  [01]	--"0" / "1"	'
..'	CHAR           <-  [\1-\127]	'
..'	CR             <-  "\13"	'
..'	CRLF           <-  CR? LF	'
...
..'	DIGIT          <-  [\48-\57]	'
..'	DQUOTE         <-  [\34]	'
..'	HEXDIG         <-  [0-9A-F]	' --DIGIT / "A" / "B" / "C" / "D" / "E" / "F"
..'	HTAB           <-  "\9"	'
..'	LF             <-  "\10"	'
..'	LWSP           <-  (WSP / CRLF WSP)*	'
..'	OCTET          <-  [\0-\255]	'
