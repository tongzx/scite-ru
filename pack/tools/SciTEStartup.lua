...
------------------------------------------------------------------------------
-- Инвертирование параметра сохранять/несохранять файл сессии
-- (используется для снятия/установки этого параметра в меню)
...
-- Предустановка параметров сохранения сессии
