...
добавл€ем выделенный текст в аббревиатуры данного €зыка, задать аббревиатуру можно в диалоговом окне
-------------------------------------------------
...
if #sel_text < 10 then return end --ограничим минимум длины строки дл€ аббревиатуры
