...
//!#define VERSION_SCITE "3.2.4"
#define VERSION_SCITE "3.2.4 .98Ru"
//!#define VERSION_WORDS 3, 2, 4, 0
#define VERSION_WORDS 3, 2, 4, 98
#define COPYRIGHT_DATES "December 1998-January 2013"
