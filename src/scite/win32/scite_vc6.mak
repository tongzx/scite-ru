...
CCFLAGS=-TC -W3 -D_CRT_SECURE_NO_DEPRECATE=1
...
#!-[NoStatic] ALL: $(PROG) $(PROGSTATIC) $(DLLS) $(PROPS)
ALL: $(PROG) $(DLLS)
...
#++Autogenerated -- run scintilla/src/LexGen.py to regenerate
#**1:\($(DIR_BIN)\\\*:\t..\\src\\\*\n\tcopy ..\\src\\\* $@\n\)
$(DIR_BIN)\abap.properties:	..\src\abap.properties
	copy ..\src\abap.properties $@
...
$(DIR_BIN)\txt2tags.properties:	..\src\txt2tags.properties
	copy ..\src\txt2tags.properties $@
