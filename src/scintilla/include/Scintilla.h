...
#define SCI_GETLEXERLANGUAGE 4012 //!-add-[GetLexerLanguage]
...
#define SCI_SETFOLDHIGHLIGHTCOLOUR 4018 //!-add-[HighlightCurrFolder]
...
//-start-[OnClick]
#define SCN_CLICK 2025
//-end-[OnClick]
#define SCN_MOUSEBUTTONUP 2026 //!-add-[OnMouseButtonUp]
