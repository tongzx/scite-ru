...
//!-start-[C_Word]
	WordList &keywords5 = *keywordlists[4];//SCE_C_WORD3
	WordList &keywords6 = *keywordlists[5];//SCE_C_WORD4
	WordList &keywords7 = *keywordlists[6];//SCE_C_WORD5
//!-end-[C_Word]
...
//!-start-[C_Word]
						...
						sc.ChangeState(SCE_C_WORD4);
					} else if (keywords7.InList(s)) {
						sc.ChangeState(SCE_C_WORD5);
					}
//!-end-[C_Word]
					sc.SetState(SCE_C_DEFAULT);
				}
